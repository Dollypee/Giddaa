...
const HeroSection = () => {
  return (
    <div className='flex flex-col lg:flex-row pl-4 md:pl-8 lg:pl-14'>
      <div className='mt-20 pr-4 text-center lg:text-left lg:w-[40%]'>
        ...
        <div className='mt-5 flex flex-col lg:flex-row lg:space-x-4'>
          ...
          <span className='giddaa-button-transparent w-full rounded-lg my-4 lg:my-0 p-4 text-center font-bold'>10,000 People Have Seen This</span>
        </div>
      </div>
      <div className='lg:w-[60%]'>
        <img src={HeroImage} alt='Giddaa Hero Banner' className='h-full' />
      </div>
