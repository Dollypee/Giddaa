...
const reviews = [
  ...
  {
    message: "They sell to diasporan clients at higher prices, that’s price discrimination. It is not fair.",
    reviewer: "~ SOMEONE IN CANADA"
  },
  {
    message: "They gave me a housing list on paper to find the house. In today’s tech world? Haba!",
...
const WhyGiddaa = () => {
  return (
    <div className="giddaa-bg-light-accent-green lg:pl-14">
      ...
      <div className="py-8">
        <p className="flex w-[60%] mx-auto text-center giddaa-heading-three flex-col">Too many Nigerians at home and abroad have complained about scams, inavailabilty of flexible payment options, how stressful, ambiguous, and manual the property purchase process is, we heard you all, <span className="font-bold">over 100+ of you!</span></p>
      </div>
      <div className="py-8">
